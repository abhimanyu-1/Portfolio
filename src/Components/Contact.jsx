...
const socialLinks = [
    {
      href: 'https://github.com/abhimanyu-1',
    ...
    {
      href: 'https://www.linkedin.com/in/abhimanyu-s-51a2a1269/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://abhimanyu-1.github.io/abhimanyu-live/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/keessuu/',
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                <h2 className="headline-2 lg:max-w-[12ch]">
                    Contact me for collaboration</h2>
                ...
                <div className="flex items-center gap-3 mt-3">
                    {socialLinks.map(({href,icon},key)=>(
                        ...
                        href={href}
                        target="_blank"
                        className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[bakcground-color , color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80">{icon}</a>
                    ))}
                </div>
            </div>

            <form 
            action="https://getform.io/f/byvpxeoa"
            method="POST"
            className="xl:pl-10 2xl:pl-20">
                ...
                <div className="md:grid md:items-center md:grid-cols-1 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" name="email" id="email" autoComplete="email" required placeholder="mail@example.com" className="text-field"/>
                    </div>

                    <div className="mb-4">
                        <label htmlFor="message" className="label">Message</label>
                        <textarea className="text-field resize-y min-h-32 max-h-80" 
                        name="message" id="message" required placeholder="Hi !"></textarea>
                    </div>
